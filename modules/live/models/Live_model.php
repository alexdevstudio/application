...
/*
		...
		if($newSku['new']){
			...
			else
			{
				...
				if($c == "accessories" || $c == "barcode_scanners" || $c == "barcode_printers" || $c == "cable_accessories" || $c == "cables" || $c == "card_readers" ||
				   ...
				   $c == "ip_phones" || $c== "ip_pbx" || $c == "keyboard_mouse" || $c == "laptops" || $c == "memories" || $c == "motherboards" ||
      ...
      Modules::run("extract/allImport", $c, 'one', 0, $sku);
      // https://etd.gr/xml/extract/allImport/all/all/0/1323281_1324237
    }
		/*
		else {
